...
#   provider                     = aws.saopaulo
#   transit_gateway_attachment_id = var.tokyo_to_saopaulo_tgw_attachment_id
...
#   transit_gateway_attachment_id = data.terraform_remote_state.tokyo.outputs.tokyo_to_saopaulo_tgw_attachment_id

#   tags = {
#     Name = "${var.project_name}-liberdade-accept-peer01"
#   }
# }
resource "aws_ec2_transit_gateway_peering_attachment_accepter" "liberdade_accept_peer" {
  ...
  tags = {
    Name = "${var.project_name}-liberdade-accept-peer"
  }
}
