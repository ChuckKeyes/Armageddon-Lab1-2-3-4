...
resource "aws_vpc"  "lab3cek_vpc01" {
...
resource "aws_subnet"  "lab3cek_private_subnet01" {
...
resource "aws_subnet"  "lab3cek_private_subnet02" {
  vpc_id            = aws_vpc.lab3cek_vpc01.id
...
resource "aws_route_table"  "lab3cek_private_rt01" {
  vpc_id = aws_vpc.lab3cek_vpc01.id
  tags   = { Name = "${var.project_name}-tokyo-private-rt01" }
}

resource "aws_route_table_association"  "lab3cek_private_assoc01" {
  subnet_id      = aws_subnet.lab3cek_private_subnet01.id
  route_table_id = aws_route_table.lab3cek_private_rt01.id
}

resource "aws_route_table_association"  "lab3cek_private_assoc02" {
  subnet_id      = aws_subnet.lab3cek_private_subnet02.id
  route_table_id = aws_route_table.lab3cek_private_rt01.id
}
