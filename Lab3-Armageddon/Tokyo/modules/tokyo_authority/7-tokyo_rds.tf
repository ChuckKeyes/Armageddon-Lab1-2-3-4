...
resource "aws_db_subnet_group" "lab3cek_rds_subnet_group_tokyo" {
...
resource "aws_db_instance" "lab3cek_rds_tokyo" {
  ...
  db_subnet_group_name   = aws_db_subnet_group.lab3cek_rds_subnet_group_tokyo.name
  vpc_security_group_ids = [aws_security_group.lab3cek_rds_sg01.id]
